...
import com.tecrt.rohitthomas.tecrtmedia.encoder.MediaAudioEncoder;
import com.tecrt.rohitthomas.tecrtmedia.encoder.MediaEncoder;
import com.tecrt.rohitthomas.tecrtmedia.encoder.MediaMuxerWrapper;
...
//        togglePlay = false;
        ...
        togglePlay = false;
        showToast("onItemSelected: " + mSelectedMovie + " '" + mMovieFiles.getItem(mSelectedMovie) + "'");

    }

    void showToast(String message) {
        Toast toast = Toast.makeText(MediaActivity.this, message, Toast.LENGTH_SHORT);
    ...
    protected boolean toggleMode = true;
     ...
     */
    private class GlobalObserver implements View.OnClickListener {

        public void onClick(final View v) {
            int i = v.getId();
            if (i == R.id.button_menu) {
                if (toggleMenu) {//TODO Priority: Reduse number of clicks to open GLview
                ...
                if (toggleVideoMenu) {
                    ...
                    if (toggleMode) {
                        ...
                        showUIElement(Techniques.FadeInRight, 700, findViewById(R.id.playMovieFile_spinner));
                        hideUIElement(Techniques.FadeOutRight, 700, findViewById(R.id.layout_menuCamera));
                        showToast("Video Editor");
...
//                YoYo.with(Techniques.RotateIn).duration(700).playOn(findViewById(R.id.button_camera_video));
                ...
                //Camera Buttons
            } else if (i == R.id.button_camrotate) {
            ...
            } else if (i == R.id.button_reset) {//                    if (player != null) {
//                        player.release();
//                        VideoUpdate = true;
//                    }
                StopVideo();
...
//                        if(player != null)player.pause();
            ...
            } else if (i == R.id.button_saveedit) {
    ...
    private final class FiltersObserver implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            } else if (i == R.id.filter_Cartoon) {
                mSharedData.mFilter = 10;

                // Edges Filter button
            } else if (i == R.id.filter_Edges) {
        ...
        try {
            ...
            if (videoAddr != null) {
                ...
                if (useAssets) {
                    ...
                    player.setDataSource(this, Uri.parse(mVideoFolder.getAbsolutePath()+ Galfile));
                }
            } else {
            ...
            if(mVideoView == null) {
                ...
                VideoUpdate = false;
                frameLayout.addView(mVideoView);//TODO Priority: avoid blank screen by not loading view dynamicly
...
//            frameLayout.removeView(mVideoView);
    ...
    public void StartCamera() {
        ...
        if(mCameraView == null) {
            ...
            frameLayout.addView(mCameraView);//TODO Priority: avoid blank screen by not loading view dynamicly
            //mVideoView.setVideoSize(1280, 720);
...
//            frameLayout.removeView(mVideoView);
    ...
    private void startRecording() {
        showToast("startRecording:");
        try {
            mMuxer = new MediaMuxerWrapper(".mp4");	// if you record audio only, ".m4a" is also OK.
            if (true) {
                // for video capturing
                if(toggleMode) {//TODO Priority: record video without the edge error
...
//            Log.e(TAG, "startCapture:", e);
    ...
    private void stopRecording() {
        showToast( "stopRecording:mMuxer=" + mMuxer );
        if (mMuxer != null) {
    ...
    private final MediaEncoder.MediaEncoderListener mMediaEncoderListener = new MediaEncoder.MediaEncoderListener() {
        ...
        public void onPrepared(final MediaEncoder encoder) {
            showToast("onPrepared:encoder=" + encoder);
        ...
        public void onStopped(final MediaEncoder encoder) {
            showToast("onStopped:encoder=" + encoder);
            if (encoder instanceof MediaVideoEncoder) {
