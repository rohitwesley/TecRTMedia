package com.tecrt.rohitthomas.tecrtmediasample.glutils;
/*
...
import com.tecrt.rohitthomas.tecrtmediasample.tecrtData;
import com.tecrt.rohitthomas.tecrtmediasample.tecrtShader;
...
//                }
        ...
        int uPixelSize = shader.getUHandle("uPixelSize");
        int uTime = shader.getUHandle("uTime");


        // Store uniform variables into use.
        GLES20.glUniform2f(uPixelSize, (float) 1.0f/mSharedData.videoWidth, (float) 1.0f/mSharedData.videoHeight);
